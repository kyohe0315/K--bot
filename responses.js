...
module.exports = [
  ...
  { pattern: /五時った/,
    response: "水ッた" },
  { pattern: /こじんまり/,
    response: "こじんまりって書きがちだけど本当は『こぢんまり』なんだってね" },
  { pattern: /呪術海鮮/,
    response: "呪われた海鮮丼…って事!?" },
  { pattern: /うゆ/,
    response: "うゆ。" },
  { pattern: /きょれさん|おもしろかつまた|面白かつまた|おもしろかつた|面白かつた|たのしかつた|楽しかつた|たのしかつまた|楽しかつまた/,
    response: "ｗｗｗお前ｗｗｗ 五時ってやんのｗｗｗ" },
  { pattern: /かっこいいすごいきゃ/,
    response: "へこうるさい" },
  ...
  { pattern: /自律感覚絶頂反応/,
    response: ["呼びました？？",
               "https://youtu.be/dIytbctX0iE"]},
  { pattern: /ESAMは|Esamは|esamは/,
    response: "神の🥚" },
  { pattern: /サーモンのねぎ塩ユッケ|サーモンのネギ塩ユッケ/,
    response: ["マジでおいしそうだよな",
               "https://pbs.twimg.com/media/FdUV0C0VEAI4AXR?format=jpg&name=large"]},
  { pattern: /回文/,
    response: "きいろいしんぶんし" },
  { pattern: /deepl|Deepl|deepL|DeepL|DEEPL/,
    response: "https://www.deepl.com/ja/translator" },
  { pattern: /誕生日おめでと/,
    response: ["おめでとーーー！！！🎊✨㊗",
               "https://cdn.glitch.global/68ce99b8-0619-4731-b98b-b5d54a5d616e/medium.gif?v=1677097580867"]},
  { pattern: /いい加減にせい|いいかげんにせい/,
    response: "https://x.gd/Hr8Tp" },
