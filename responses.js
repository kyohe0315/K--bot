...
module.exports = [
  ...
  { pattern: /五時った/,
    response: "水ッた" , type: "static"},
  { pattern: /こじんまり/,
    response: "こじんまりって書きがちだけど本当は『こぢんまり』なんだってね" , type: "static"},
  { pattern: /呪術海鮮/,
    response: "呪われた海鮮丼…って事!?" , type: "static"},
  { pattern: /うゆ/,
    response: "うゆ。" , type: "static"},
  { pattern: /きょれさん|おもしろかつまた|面白かつまた|おもしろかつた|面白かつた|たのしかつた|楽しかつた|たのしかつまた|楽しかつまた/,
    response: "ｗｗｗお前ｗｗｗ 五時ってやんのｗｗｗ" , type: "static"},
  { pattern: /かっこいいすごいきゃ/,
    response: "へこうるさい" , type: "static"},
  ...
  { pattern: /いい加減にせい|いいかげんにせい/,
    response: "https://x.gd/Hr8Tp" , type: "static"},
